...
#define BLACKSCHOLES HASH("benchmarks/BlackScholes2/BlackScholes_kernel.cuh")
#define RNG HASH("benchmarks/quasirandomGenerator2/quasirandomGenerator_kernel.cu")
#define TRANSPOSE HASH("benchmark/6_Advanced/transpose2/transpose.cu")
#define GAUSSIAN HASH("benchmarks/gaussian2/gaussian_kernel.cu")
#define MMUL HASH("benchmarks/0_Simple/matrixMul2/matrixMul.h")
